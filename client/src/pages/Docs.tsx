      ...
      <div className="mb-8">
        <div className="flex items-start justify-between gap-6 flex-wrap">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="group shrink-0 inline-flex items-center gap-2 px-3 py-1.5 rounded-lg border hairline text-[12.5px] text-[var(--ink-2)] hover:text-[var(--ink)] hover:bg-[var(--ink)]/[.04] transition-colors">
...
function CookbookDetailPage({ slug, onGo }: { slug: string; onGo: (a: Active) => void }) {
  ...
  return (
    <div>
      ...
      {/* 在 Colab 中打开 / 在 GitHub 查看：skill-integration 跳转官方 README quickstart，其余 14 个跳转官方 cookbook ipynb */}
      <div className="mt-4 flex items-center gap-3">
        {item.slug === 'skill-integration' ? (
          <a
            href="https://github.com/opendatalab/Sciverse-Agent-Tools#quickstart--skills-cli"
            target="_blank"
            rel="noreferrer"
            ...
            在 GitHub 查看 Quickstart
          </a>
        ) : (
          <>
            <a
              href={`https://colab.research.google.com/github/opendatalab/Sciverse-Agent-Tools/blob/main/cookbooks/${item.slug}.ipynb`}
              target="_blank"
              rel="noreferrer"
            ...
            <a
              href={`https://github.com/opendatalab/Sciverse-Agent-Tools/blob/main/cookbooks/${item.slug}.ipynb`}
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-1.5 px-3 py-2 rounded-lg border hairline text-[12px] text-[var(--ink-2)] hover:text-[var(--ink)] hover:border-[var(--ink)]/30 transition-all duration-200">
              <svg className="h-3.5 w-3.5" viewBox="0 0 24 24" fill="currentColor">
